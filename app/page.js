...
function Home() {
    return (<main className="min-h-screen flex items-center justify-center bg-linear-to-br from-blue-50 to-indigo-100">
      <div className="max-w-4xl mx-auto px-6 py-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8 mb-12">
          {/* Bouton Connexion */}
          <link_1.default href="/login" className="bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold text-lg
          ...
          {/* Bouton Inscription */}
          <link_1.default href="/register" className="bg-white text-blue-600 border-2 border-blue-600 px-8 py-4 rounded-lg 
        ...
        <div className="mt-12">
          <p className="text-gray-600">
            ...
            <link_1.default href="/dashboard" className="text-blue-600 hover:text-blue-800 font-semibold ml-2">
